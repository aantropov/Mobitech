...
extern "C" {
    ...
    JNIEXPORT void JNICALL Java_com_android_gl2jni_GL2JNILib_initResourceFactory(JNIEnv * env, jclass jclazz, jobject java_asset_manager);
...
JNIEXPORT void JNICALL Java_com_android_gl2jni_GL2JNILib_initResourceFactory(JNIEnv * env, jclass jclazz, jobject java_asset_manager)
{
    ...
    //eng->APK_ROOT = env->GetStringUTFChars(eng->main_resource_factory.asset_manager eng->main_resource_factory.asset_manager-> , &isCopy); 
